  ...
  const doDeletePrice = async (price: Price) => {
    ...
    try {
      ...
      const filteredTickets = tickets.filter(
        (iTicket: Price) => iTicket.id !== price.id,
      );
      ...
      console.error('Unepxected error while trying to delete the Event Price', {
        ...error,
      });
      setError(true);
  ...
  const doUpdateOrCreatePrice = async (price: Price) => {
    ...
    try {
      ...
      const ticketIndex = tickets.findIndex(
        (iPrice: Price) => iPrice.id === price.id,
      );
      ...
      setMessageBar({
        type: 'success',
        message: 'Price was successfully saved',
      });
    } catch (error: any) {
      console.error('Unexpected error while trying to save Price', {
        ...error,
      });
